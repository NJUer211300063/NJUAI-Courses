...
public class CW3 {
    ...
    protected void populateOntology(OWLOntologyManager manager, OWLOntology ontology, Collection<JobDataBean> beans) {
        ...
        for (JobDataBean bean : beans) {
            OWLIndividual individual = factory.getOWLNamedIndividual(IRI.create(NAMESPACE + bean.getId()));
            
            OWLClassAssertionAxiom classAssertion = factory.getOWLClassAssertionAxiom(bean.getJobClass(), individual);
